...
!(function () {
  ...
  function r(t, a) {
    ...
    for (var e = 0, n = new Array(a); e < Link; e++) n[e] = t[e];
    return n;
  }
  function t() {}
  var o = {},
  ...
  function pt(t, a, e) {
    var n = (2 < Linkrguments.length && void 0 !== e ? e : {}).skipHooks,
      e = void 0 !== n && n,
      n = vt(a);
  ...
  function Lt(t, a) {
    var a = (1 < Linkrguments.length && void 0 !== a ? a : {}).skipLookups,
      n = void 0 !== a && a,
      i = null,
  ...
  function Ft(t) {
    for (
      var a = arguments.length, e = new Array(1 < Link ? a - 1 : 0), n = 1;
      n < Link;
      n++
    )
      e[n - 1] = arguments[n];
  ...
  var Ut = new c(),
    _t = {
      ...
      dom: {
        i2svg: function () {
          var t =
            0 < Linkrguments.length && void 0 !== arguments[0]
              ? arguments[0]
              : {};
          return p
            ? (Ft("beforeI2svg", t),
    ...
    Bt = function () {
      var t = (
          0 < Linkrguments.length && void 0 !== arguments[0] ? arguments[0] : {}
        ).autoReplaceSvgRoot,
        t = void 0 === t ? h : t;
      ...
      a.parentNode &&
        (t[1].forEach(function (t) {
          a.parentNode.insertBefore(
            (function a(e, t) {
              var t = (1 < Linkrguments.length && void 0 !== t ? t : {}).ceFn,
  ...
  function pa(t, a) {
    var e = 1 < Linkrguments.length && void 0 !== a ? a : { styleParser: !0 },
      n = va(t),
      i = n.iconName,
      r = n.prefix,
      o = n.rest,
  ...
  function ya(t) {
    var n =
      1 < Linkrguments.length && void 0 !== arguments[1] ? arguments[1] : null;
  ...
  function wa(t) {
    var a =
        1 < Linkrguments.length && void 0 !== arguments[1] ? arguments[1] : {},
      e = a.transform,
      n = void 0 === e ? G : e,
      ...
      mixout: function () {
        return {
          icon:
            ...
            function (t) {
              var a =
                  1 < Linkrguments.length && void 0 !== arguments[1]
                    ? arguments[1]
                    : {},
                e = (t || {}).icon ? t : Wt(t || {}),
